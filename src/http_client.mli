...
(** [rpc fd request body f] marshals the HTTP request represented by
    [request] and [body] through file descriptor [fd] and then applies
    the response to [f]. On failure an exception is thrown. *)
val rpc :
  Unix.file_descr ->
  Http.Request.t ->
